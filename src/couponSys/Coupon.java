...
public class Coupon {
    ...
    public Coupon( int i_companyID, Category i_category, String i_title, String i_description, Date i_startDate, Date i_endDate, int i_amount, double i_price, String i_image) {
        this.m_companyID = i_companyID;
        this.m_category = i_category;
        this.m_title = i_title;
        this.m_description = i_description;
